...
Partial Class Relatorios_MovimentacaoProdutos_ExibeRelatorio
    ...
    Private Sub CarregaRelatorio()
        ...
        Try
            ...
            strSQL.Append(" prod_estoque.codigo, Produto_laboratorio.codigo as codigo_cetec, Produto_laboratorio.Nome, Produto_laboratorio.Unidade,  prod_estoque.Qtd_Estoque,  prod_estoque.idUnidade,  movimenta_estoque.id_prod_lab, movimenta_estoque.Quantidade, movimenta_estoque.Entrada_Saida, movimenta_estoque.data_entradaSaida, movimenta_estoque.id_prod_estoque, Produto_laboratorio.concentracao,  ")
            strSQL.Append(" ( select SUM(case when me.Entrada_Saida = 'E' then me.Quantidade else me.Quantidade * (-1) end)	from movimenta_estoque me where me.id_prod_lab = prod_estoque.id_prod_lab and me.setor = prod_estoque.idUnidade and me.id_prod_estoque = prod_estoque.id_prod_estoque) as EstoqueAtual ")
            ...
            strSQL.Append(" ORDER BY Produto_laboratorio.Nome, prod_estoque.idUnidade, movimenta_estoque.data_entradaSaida DESC ")
