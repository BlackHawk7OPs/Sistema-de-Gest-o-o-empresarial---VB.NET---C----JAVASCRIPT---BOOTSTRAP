...
Partial Class Relatorios_GAS_RelatorioGASMesAno
    ...
    Private Sub CarregaRelatorio()
        ...
        Try
            ...
            strSQL.Append(" SELECT RIGHT(CONVERT(VARCHAR(10), g.data_emissao, 103), 7) AS mesAno, SUM(g.preco_bruto) AS Bruto, SUM(g.desconto) AS Desconto, SUM(g.preco) AS Liquido ")
            ...
            strSQL.Append("     GROUP BY RIGHT(CONVERT(VARCHAR(10), g.data_emissao, 103), 7) ")
            strSQL.Append("     ORDER BY RIGHT(CONVERT(VARCHAR(10), g.data_emissao, 103), 7) ")
